...
public class ActivityInfoTutoria extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView TVTutorInfo = (TextView)findViewById(R.id.TVTutorInfo);
        ...
        if(b != null){
            ...
            //TVTutorInfo.setText("Bryan");
            IVProfileTutorInfo.setImageResource(R.drawable.girl);

        }
        CreateTutorshipButton.setOnClickListener(this);

        TVTutorInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(ActivityInfoTutoria.this, ActivityInfoTutor.class);
                i.putExtra("nombre", TVTutorInfo.getText().toString());
                startActivity(i);
            }
        });
    }
    ...
    @Override
    public void onClick(View v) {
        if(v == CreateTutorshipButton){
            Toast Join = Toast.makeText(getApplicationContext(),"Inscrito Correctamente",Toast.LENGTH_LONG);
            Join.show();
            //codigo con la base de datos
        }
        if(v == EstudentsListButton){
